...
require 'bridgetown_picture_tag/version'

Gem::Specification.new do |spec|
  spec.name = 'bridgetown_picture_tag'
  spec.authors = ['Robert Wierzbowski', 'Brendan Tobolaski',
                  'Robert Buchberger', 'Daniil Sivak']
  spec.email = ['seroperson@gmail.com']
  spec.homepage = 'https://github.com/seroperson/bridgetown_picture_tag'
  spec.metadata = { 'documentation_uri' =>
                         'https://rbuchberger.github.io/jekyll_picture_tag/' }
  spec.license = 'BSD-3-Clause'
  spec.summary = 'Easy responsive images for Bridgetown.'
  spec.description = <<-HEREDOC
    Bridgetown Picture Tag adds responsive images to your Bridgetown static site. It
