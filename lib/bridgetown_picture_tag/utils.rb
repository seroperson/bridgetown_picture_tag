  ...
  module Utils
    class << self
      ...
      def keep_files
        ...
        dest_dir = dest_dir[0..-2] if dest_dir.end_with?('/')
      ...
      def warning(message)
        ...
        warn 'Bridgetown Picture Tag Warning: '.yellow + message
      end
      ...
      def markdown_page?
        page_name = PictureTag.page.path
        page_ext = PictureTag.page.extname
