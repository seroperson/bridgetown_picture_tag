...
require_relative 'bridgetown_picture_tag/builder'
require_relative 'bridgetown_picture_tag/cache'
require_relative 'bridgetown_picture_tag/images'
require_relative 'bridgetown_picture_tag/instructions'
require_relative 'bridgetown_picture_tag/output_formats'
require_relative 'bridgetown_picture_tag/parsers'
require_relative 'bridgetown_picture_tag/router'
require_relative 'bridgetown_picture_tag/srcsets'
require_relative 'bridgetown_picture_tag/utils'
require_relative 'bridgetown_picture_tag/defaults/presets'
require_relative 'bridgetown_picture_tag/defaults/global'

Bridgetown.initializer :bridgetown_picture_tag do |config|
  config.builder BridgetownPictureTag::Builder
end

# Title: Bridgetown Picture Tag
# Authors: Rob Wierzbowski   : @robwierzbowski
#          Justin Reese      : @justinxreese
#          Welch Canavan     : @xiwcx
#          Robert Buchberger : @celeritas_5k
#          Daniil Sivak      : @seroperson (bridgetown adaption)
#
# Description: Easy responsive images for Bridgetown.
#
